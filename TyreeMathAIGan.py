...
def discriminator(image, reuse=False):
    ...
    layer1 =  pooling_layer(layer1, 5, 2)
    ...
    layer2 = pooling_layer(layer2, 5, 2)
...
def conv_layer(layer, kernel, input_shape, output_shape, stride_size, biases):
...
for i in range(100000):
    ...
    if i % 1000 == 0:
        ...
        for j in range(3):
            ...
            im = images[j, :, :, 0]
            plt.imsave('imageAt' + str(i) +  'TyreeMath.png', im.reshape([28, 28]), cmap='Greys')
            #plt.show()
...
for i in range(10):
    print(test_eval[i])
    plt.imsave('generated_images' + str(i) + '.png', test_images[i, :, :, 0], cmap='Greys')
    #plt.show()

for i in range(10):
    print(real_eval[i])
    plt.imsave('real_images' + str(i) + '.png', test_images[i, :, :, 0],cmap='Greys')
    #plt.show()
