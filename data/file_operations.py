...
moveFilesToTestDirectory('train/tulip')
moveFilesToTestDirectory('train/rose')
moveFilesToTestDirectory('train/dandelion')
moveFilesToTestDirectory('train/sunflower')

moveFilesToTestDirectory('train/daisy')
